    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-12 col-lg-12 col-sm-12 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">${{getAmount($widget['total_deposit_amount'])}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Deposit') USD</span>
                    </div>
...
@if(auth()->guard('admin')->user()->superadmin != 1)
@php
$wallet = App\Models\Userwallet::whereWcode(auth()->guard('admin')->user()->wcode)->first();
@endphp
<div class="row mt-50 mb-none-30">
    <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
            ...
            b-radius--10 box-shadow" >
                ...
                <div class="details">
                    ...
                    <a href="{{route('admin.mycreditlog')}}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View Funding')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg-danger b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['staff_pending_orders']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Awaiting Dispatch')</span>
                    </div>
                    <a href="{{ route('admin.order.dispatched') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-6 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{$widget['staff_delivered_orders']}}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Delivered')</span>
                    </div>
                    <a href="{{ route('admin.order.delivered') }}" class="btn btn-sm text--small bg--white text--black box--shadow3 mt-3">@lang('View All')</a>
                </div>
            </div>
