                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('VAT ') </label>
                                    <input class="form-control form-control-lg" type="text" name="vat" value="{{$general->vat}}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label class="form-control-label font-weight-bold">@lang('Referral Earning') % </label>
                                    <input class="form-control form-control-lg" type="text" name="ref" value="{{$general->ref}}">
                                </div>
                            </div>
