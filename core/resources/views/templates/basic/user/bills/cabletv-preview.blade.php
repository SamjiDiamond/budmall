             ...
             <div class="card border-0 shadow-md">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush text-center ">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">@lang('Bouquet'): <strong>{{$planname}}</strong></li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Service Charge'): <strong>{{$general->cur_sym}}{{env('CABLECHARGE')}}</strong>
                            </li>


                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Total NGN'): <strong>{{$general->cur_sym}}{{showAmount($cost + env('CABLECHARGE'),2)}} </strong>
                            </li>

                            <li class="list-group-item d-flex justify-content-between align-items-center">
                            @php
                            $total = $cost + env('CABLECHARGE');
                            @endphp
