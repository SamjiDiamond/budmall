...
class DepositController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $val['description'] = "Deposit with Stripe";
        $val['image'] = "https://budmall.ng/assets/images/logoIcon/logo.png";
        $val['amount'] = $deposit->amount * 100;
        ...
        $send['view'] = 'user.deposit.' . $alias;
        $send['method'] = 'post';
        $send['url'] = route('ipn.deposit.'.$gate->alias);
    ...
    public function ipn(Request $request)
    {
        ...
        $charge = Charge::create([
            ...
            'amount' => round($deposit->amount*100),
